...
public class DefaultJwtSettingsValidator implements JwtSettingsValidator {
    ...
    public void validate(JwtSettings jwtSettings) {
        ...
        if (decodedKey.length * Byte.SIZE < JwtSettingsService.TOKEN_SIGNING_KEY_MIN_SIZE_BITS
                && !JwtSettingsService.TOKEN_SIGNING_KEY_DEFAULT.equals(jwtSettings.getTokenSigningKey())) {
