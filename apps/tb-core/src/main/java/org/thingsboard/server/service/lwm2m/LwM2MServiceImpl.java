...
public class LwM2MServiceImpl implements LwM2MService {
    ...
    private final LwM2MSecureServerConfig serverConfig;
    private final Optional<LwM2MSecureServerConfig> bootstrapConfig;

    public LwM2MServiceImpl(
            @Qualifier("lwM2MTransportServerConfig") LwM2MSecureServerConfig serverConfig,
            @Qualifier("lwM2MTransportBootstrapConfig") Optional<LwM2MSecureServerConfig> bootstrapConfig) {
