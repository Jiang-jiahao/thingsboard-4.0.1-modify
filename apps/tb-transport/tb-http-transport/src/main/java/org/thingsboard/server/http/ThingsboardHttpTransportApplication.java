...
@EnableAsync
@EnableScheduling
@ComponentScan({"org.thingsboard.server.http", "org.thingsboard.server.common", "org.thingsboard.server.transport.http", "org.thingsboard.server.queue", "org.thingsboard.server.cache", "org.thingsboard.transport.base", "org.thingsboard.transport.provider"})
