 ...
 * {@link #protocolCommands 上行/下行命令}。上行命令展开为 {@link HexTransportUdpDataConfiguration} 供 Udp HEX <b>解析</b>；
 * 下行命令的字段定义仅作<strong>组帧参数契约</strong>持久化，不参与当前 Udp 侧解析展开。
 */
@Data
public class ProtocolTemplateTransportUdpDataConfiguration implements TransportUdpDataTypeConfiguration {
     ...
     */
    public HexTransportUdpDataConfiguration expandToHexTransportUdpDataConfiguration() {
        HexTransportUdpDataConfiguration hex = new HexTransportUdpDataConfiguration();
