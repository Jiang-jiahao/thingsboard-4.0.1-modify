...
public class RuleEngineJwtSettingsValidator implements JwtSettingsValidator {
    ...
    public void validate(JwtSettings jwtSettings) {
        ...
        if (decodedKey.length * Byte.SIZE < KEY_LENGTH && !JwtSettingsService.TOKEN_SIGNING_KEY_DEFAULT.equals(jwtSettings.getTokenSigningKey())) {
