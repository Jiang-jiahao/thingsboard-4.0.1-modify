...
public class TcpProtoTransportEntityService {
    ...
    public TransportProtos.GetTcpDevicesResponseMsg getTcpDevicesIds(int page, int pageSize) {
        TransportProtos.GetTcpDevicesRequestMsg requestMsg = TransportProtos.GetTcpDevicesRequestMsg.newBuilder()
                .setPage(page)
