...
import org.thingsboard.server.transport.tcp.limits.IpFilter;
import org.thingsboard.server.transport.tcp.limits.ProxyIpFilter;
...
public class TcpTransportServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public TcpTransportServerInitializer(TcpTransportContext context) {
