...
/**
 * MQTT Pull 仅上报遥测，不处理 RPC/属性下行。
 */
public final class MqttPullNoOpSessionListener implements SessionMsgListener {

    public static final MqttPullNoOpSessionListener INSTANCE = new MqttPullNoOpSessionListener();

    private MqttPullNoOpSessionListener() {
    }
