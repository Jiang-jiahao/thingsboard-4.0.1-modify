...
public final class HttpPullJsonHelper {
    ...
    public static List<Object> readArrayElements(String jsonBody, String arrayJsonPath) {
        ...
        DocumentContext ctx = JsonPath.using(JSON_PATH_CONF).parse(jsonBody);
    ...
    public static String readJsonPath(String jsonBody, String path) {
        if (StringUtils.isBlank(jsonBody) || StringUtils.isBlank(path)) {
            return null;
        }
        try {
