...
class UdpHexProtocolParserTest {
    ...
    void parsesUint16BeAndFloatBe() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, List.of(a, b), null, null, UUID.randomUUID());
    ...
    void scaleAndMask() {
        ...
        out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, List.of(a), null, null, UUID.randomUUID());
    ...
    void bytesAsUtf8Payload() {
        ...
        f.setByteLength(5);
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, List.of(f), null, null, UUID.randomUUID());
        assertThat(out).isPresent();
    ...
    void bytesAsHexDynamicLengthWithIntegralSubtract() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, List.of(body), null, null, UUID.randomUUID());
        assertThat(out).isPresent();
    ...
    void fixedIntegralMismatchOnCommandRuleFallsThroughToDefaultFields() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, List.of(cmd), List.of(def), null, null, UUID.randomUUID());
        assertThat(out).isPresent();
    ...
    void fixedMismatchSkipsFirstCommandRuleSecondStillMatches() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, List.of(bad, good), List.of(), null, null, UUID.randomUUID());
        assertThat(out).isPresent();
    ...
    void commandProfileSecondaryMatchDistinguishesSamePrimary() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload,
    ...
    void ltvRepeatingParsesChunks() {
        ...
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, null, ltv, null, UUID.randomUUID());
        assertThat(out).isPresent();
    ...
    void ltvUnknownTagEmitHexUsesHexSuffixFromMappingTagValueLiterallyHex() {
        ...
        assertThat(UdpHexProtocolParser.effectiveUnknownTagTelemetryKeyHexLiteral(ltv)).isTrue();
        var out = UdpHexProtocolParser.tryParseTelemetryFromHexPayload(payload, null, null, ltv, null, UUID.randomUUID());
        assertThat(out).isPresent();
        assertThat(out.get().has("lx_unk_0_t0x07000301")).isTrue();
    }
