...
/**
 * 原始字节（历史枚举名 {@link org.thingsboard.server.common.data.TransportUdpDataType#HEX}）的 Udp 传输数据配置。
 *
 * @author jiahaozz
 * <p>
 * <p>
 ...
 */
@Data
public class HexTransportUdpDataConfiguration implements TransportUdpDataTypeConfiguration {
    ...
    public TransportUdpDataType getTransportUdpDataType() {
        return TransportUdpDataType.RAW_BYTES;
    }
