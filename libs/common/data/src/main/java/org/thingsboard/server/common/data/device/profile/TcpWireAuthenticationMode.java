 ...
 * 与当前 Socket 的<strong>本地监听端口</strong>及设备传输配置中的 {@link org.thingsboard.server.common.data.device.data.TcpDeviceTransportConfiguration#getTcpWireAuthPayloadDeviceId() tcpWireAuthPayloadDeviceId}
